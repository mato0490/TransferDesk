        ...
        kids=[
            versioninfo.StringFileInfo([
                versioninfo.StringTable('040904B0', [
                    versioninfo.StringStruct('CompanyName', 'TransferDesk'),
                    versioninfo.StringStruct('FileDescription', 'TransferDesk'),
                    versioninfo.StringStruct('FileVersion', __version__),
                    versioninfo.StringStruct('InternalName', 'TransferDesk'),
                    versioninfo.StringStruct('OriginalFilename', 'TransferDesk.exe'),
                    versioninfo.StringStruct('ProductName', 'TransferDesk'),
...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'PIL.Image', 'transferdesk_core', 'transferdesk_updater',
...
if sys.platform == 'darwin':
    exe = EXE(
        ...
        name='TransferDesk', debug=False, strip=False, upx=True,
    ...
    app = BUNDLE(
        ...
        version=__version__,
        info_plist={
            'CFBundleDisplayName': 'TransferDesk',
            'CFBundleName': 'TransferDesk',
